  ...
  getDb()
    .prepare(
      `UPDATE simulations SET
        ...
        mandate_duration_months = ?,
        gov_sealed_month = ?, gov_poll_weak_streak = ?,
    ...
    .run(
      ...
      patch.gov_sealed_month !== undefined
        ? patch.gov_sealed_month
        : current.gov_sealed_month ?? null,
      patch.gov_poll_weak_streak !== undefined
        ? patch.gov_poll_weak_streak
        : current.gov_poll_weak_streak ?? 0,
      id
    );
}
